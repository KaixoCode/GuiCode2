...
namespace GuiCode
{
    ...
    struct Command
    {
        ...
        {
            Vec2<float> b;
            struct { float a; float b; int c; } bs;
            struct { float a; Texture b; int c; } bs2;
        };
    ...
    struct CommandCollection
    {
        ...
        void Quad(const Vec4<float>& a, float b = 0, int c = false) { m_Commands.push(Command{ .a = a, .bs = {.a = b, .c = c}, .type = Command::Quad }); };
        void TexturedQuad(Texture t, const Vec4<float>& a, float b = 0, int c = false) { m_Commands.push(Command{ .a = a, .bs2 = {.a = b, .b = t, .c = c }, .type = Command::TexturedQuad }); };
    ...
    protected:
        ...
        virtual void Quad(const glm::vec4&, float, int) = 0;
        virtual void TexturedQuad(Texture, const glm::vec4&, float, int) = 0;
